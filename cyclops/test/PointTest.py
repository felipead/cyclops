...
class PointTest(TestCase):
    ...
    def test_point_coordinates_should_be_dimension_agnostic(self):
        p1 = Point((1,2,3))
        assert p1[0] == p1.x == 1
        assert p1[1] == p1.y == 2
        assert p1[2] == p1.z == 3
    ...
    def test_empty_point_is_equal_to_zero(self):
        assert Point() == Point(()) == Point([]) == Point((0,)) == Point((0,0)) == Point((0,0,0))

    def test_equal_points_with_same_dimensions_are_equal(self):
    ...
    def test_equivalent_points_with_different_dimensions_are_equal(self):
    ...
    def test_slightly_different_points_with_same_dimensions_are_not_equal(self):
        assert Point((1,2)) != Point((1,2.3))
        assert Point((0,2)) != Point((1,2))
        assert Point((1,2,3)) != Point((1,2,4))

    def test_very_different_points_with_same_dimensions_are_not_equal(self):
        assert Point((1,2)) != Point((66,50))
        assert Point((90.99,23)) != Point((1,2))
        assert Point((5,6,7)) != Point((1,2,4))

    def test_slightly_different_points_with_different_dimensions_are_not_equal(self):
        assert Point((1,)) != Point((1,2))
        assert Point((1,2)) != Point((0,2,0))
        assert Point((1,2,4)) != Point((1,2,3,0))
        assert Point((1,2)) != Point((1,2,0,3))

    def test_very_different_points_with_different_dimensions_are_not_equal(self):
    ...
    def test_equality_with_duck_typing(self):
        assert Point((1,)) == (1,)
        assert Point((1,2,3)) == [1,2,3]
        assert Point((1,2)) == (1,2,0)

    def test_hash_code_should_be_a_function_of_coordinates(self):
    ...
    def test_hash_code_should_be_dimension_agnostic(self):
