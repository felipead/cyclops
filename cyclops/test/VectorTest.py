...
class VectorTest(TestCase):
    ...
    def test_create_2d_vector_instance_with_head_point_as_tuple(self):
        (x, y) = (1, 2)
        v = Vector((x,y))
        assert v.x == x
        assert v.y == y
    ...
    def test_create_2d_vector_instance_with_head_and_tail_points_as_tuples(self):
        (x0, y0) = (1, 2)
        (x1, y1) = (5, -6)
    ...
    def test_create_2d_vector_instance_with_head_and_tail_points_as_vectors(self):
        (x0, y0) = (1, 2)
        (x1, y1) = (5, -6)
    ...
    def test_create_3d_vector_instance_with_head_point_as_tuple(self):
        (x, y, z) = (1, 2, 3)
        v = Vector((x,y,z))
        assert v.x == x
        assert v.y == y
    ...
    def test_create_3d_vector_instance_with_head_and_tail_points_as_tuples(self):
        (x0, y0, z0) = (1, 2, 7)
        (x1, y1, z1) = (5, -6, -4)
    ...
    def test_create_3d_vector_instance_with_head_and_tail_points_as_vectors(self):
        (x0, y0, z0) = (1, 2, -3)
        (x1, y1, z1) = (5, -6, 9)
    ...
    def test_access_2d_vector_coordinates(self):
        (x, y) = (9, 5)
        v = Vector((x,y))
    ...
    def test_access_3d_vector_coordinates(self):
        (x, y, z) = (9, 5, 8)
        v = Vector((x,y,z))
        assert v[0] == v.x == v.coordinates[0] == x
        assert v[1] == v.y == v.coordinates[1] == y
    ...
    def test_1d_vector_has_length_1(self):
        v1 = Vector((5,))
    ...
    def test_2d_vector_has_length_2(self):
        v = Vector((5,3))
        assert len(v) == len(v.coordinates) == 2

    def test_3d_vector_has_length_3(self):
        v = Vector((5,3,8))
        assert len(v) == len(v.coordinates) == 3


    def test_vector_is_not_equal_to_object_with_different_type(self):
        assert Vector((5,5)) != (5,5)
        assert Vector((5,5)) != 5

    def test_vectors_with_same_coordinates_are_equal(self):
        (x,y,z) = (3,2,10)
    ...
    def test_vectors_with_different_coordinates_are_different(self):
        assert Vector((5,3)) != Vector((3,5))
        assert Vector((5,3)) != Vector((5,3,9))

    def test_hash_code_should_be_a_function_of_the_coordinates(self):
    ...
    def test_dot_product_between_vector_and_zero_is_zero(self):
        vector = Vector((5,5,7))
        zero = Vector((0,0))
    ...
    def test_perpendicular_dot_product_between_2d_vectors(self):
        (v1,v2) = (3,4.23)
        v = Vector((v1,v2))
        (w1,w2) = (8.65,3.5)
        w = Vector((w1,w2))
    ...
    def test_perpendicular_dot_product_between_3d_vectors_is_not_implemented(self):
        v = Vector((3,4.23,50))
    ...
    def test_clockwise_cross_product_between_two_2d_vectors_90_degrees_away_has_negative_z(self):
        v1 = Vector((0,50))
        v2 = Vector((100,0))
    ...
    def test_counterclockwise_cross_product_between_two_2d_vectors_90_degrees_away_has_positive_z(self):
        v1 = Vector((0,50))
        v2 = Vector((100,0))
    ...
    def test_cross_product_between_canonical_basis(self):
        i = Vector((1,0,0))
        j = Vector((0,1,0))
        k = Vector((0,0,1))
    ...
    def test_cross_product_between_parallel_vectors_is_zero(self):
        (x,y,z) = (100,50,5)
        v1 = Vector((x,y,z))
    ...
    def test_cross_product_between_vector_and_its_reflection_is_zero(self):
        v = Vector((100,50,5))
    ...
    def test_angle_between_vector_and_zero_is_zero(self):
        zero = Vector((0,0))
    ...
    def test_angle_between_zero_and_zero_is_zero(self):
        zero = Vector((0,0))
        assert zero.angle_between(zero) == 0

    def test_angle_between_equal_vectors_is_zero(self):
        error = 0.01
        v = Vector((-63,326,5))
    ...
    def test_angle_between_opposite_vectors_is_180_degrees(self):
        error = 0.0000001
        v = Vector((5, 5))
        w = Vector((-5, -5))
    ...
    def test_angle_between_parallel_vectors_is_zero(self):
        error = 0.0000001
        v = Vector((7,14.6))
        w = Vector((3.5,7.3))
    ...
    def test_angle_between_vectors_is_45_degrees(self):
        error = 0.00000000001
        v = Vector((6,0))
        w = Vector((3,3))
    ...
    def test_angle_between_vectors_is_less_than_90_degrees(self):
        v = Vector((4,5))
        w = Vector((1,2))
    ...
    def test_angle_between_vectors_is_more_than_90_degrees(self):
        v = Vector((-6,2))
        w = Vector((5,1))
    ...
    def test_angle_between_vectors_is_180_degrees(self):
        error = 0.0000001
        v = Vector((-7,-14.6))
        w = Vector((3.5,7.3))
    ...
    def test_reflection_from_reflection_is_the_original_vector(self):
        v = Vector((436,-13,40), (-950,30,2.35))
        mirror = v.reflection()
        assert mirror.reflection() == v


    def test_vector_is_clockwise_distance_from_anoter_vector(self):
        v1 = Vector((5,5))
        v2 = Vector((5,-5))
        assert v1.is_clockwise_distance_from(v2)
        assert not v2.is_clockwise_distance_from(v1)

    def test_vector_is_counterclockwise_distance_from_anoter_vector(self):
        v1 = Vector((5,-5))
        v2 = Vector((5,5))
    ...
    def test_parallel_vectors_are_at_both_clockwise_and_couterclockwise_distance_from_each_other(self):
        a = 5
        v1 = Vector((a,a))
        v2 = Vector((2*a,2*a))
        assert v1.is_clockwise_distance_from(v2)
    ...
    def test45_degree_clockwise_rotation_of_2d_vector(self):
    ...
    def test45_degree_counterclockwise_rotation_of_2d_vector(self):
        radians = math.radians(45)
        a = 5
        v = Vector((a,0))
    ...
    def test90_degree_clockwise_rotation_of_2d_vector(self):
        v = Vector((3,2), (-1,-50))
    ...
    def test90_degree_clockwise_rotation_is_clockwise_for_2d_vector(self):
        a = 4
        v = Vector((0, a))
    ...
    def test90_degree_clockwise_rotation_over_counterclockwise_rotation_is_the_original_2d_vector(self):
    ...
    def test90_degree_counterclockwise_rotation_for_2d_vector(self):
        v = Vector((3,2), (-1,-50))
        counterclockwise = v.counterclockwise_rotation_by_90_degrees()
    ...
    def test90_degree_counterclockwise_rotation_is_counterclockwise_for_2d_vector(self):
        a = 4
        v = Vector((0, a))
    ...
    def test90_degree_counterclockwise_rotation_over_clockwise_rotation_is_the_original_2d_vector(self):
        v = Vector((312,460), (-93,517))
        clockwise = v.clockwise_rotation_by_90_degrees()
    ...
    def test90_degree_clockwise_rotation_is_not_implemented_for_3d_vectors(self):
        v = Vector((5,7,9))
        exception_thrown = False
        try:
    ...
    def test90_degree_counterclockwise_rotation_is_not_implemented_for_2d_vectors(self):
        v = Vector((5,7,9))
        exception_thrown = False
        try:
    ...
    def test_clockwise_rotation_is_not_implemented_for_3d_vectors(self):
        v = Vector((5,7,9))
        exception_thrown = False
        try:
    ...
    def test_counterclockwise_rotation_is_not_implemented_for_2d_vectors(self):
        v = Vector((5,7,9))
        exception_thrown = False
        try:
    ...
    def test180_degree_clockwise_rotation_of_2d_vector(self):
        radians = math.pi
        a = 5
        v = Vector((a,0))
        clockwise = v.clockwise_rotation_by(radians)
    ...
    def test180_degree_counterclockwise_rotation_of_2d_vector(self):
        radians = math.pi
        a = 5
        v = Vector((a,0))
        counterclockwise = v.counterclockwise_rotation_by(radians)
    ...
    def test_multiplied_by_positive_scalar_with_zero_as_tail(self):
        head = (4, 32.3, 5.6, 0, 7)
        scalar = 5.3
    ...
    def test_multiplied_by_positive_scalar_with_non_zero_as_tail(self):
        head = (4, 32.3, 5)
        tail = (5, -2, 3.5)
        scalar = 5
    ...
    def test_multiplied_by_negative_scalar_with_zero_as_tail(self):
        head = (4, 32.3, 5.6, 0, 7)
        scalar = -5.3
    ...
    def test_multiplied_by_negative_scalar_with_non_zero_as_tail(self):
        head = (4, 32.3, 5)
        tail = (5, -2, 3.5)
        scalar = -10.9
    ...
    def test_multiplied_by_zero(self):
        head = (4, 32.3, 5)
        tail = (5, -2, 3.5)
        scalar = 0
