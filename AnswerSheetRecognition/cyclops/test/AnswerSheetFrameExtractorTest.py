...
from ..recognition.AnswerSheetFrameExtractor import *
...
class AnswerSheetFrameExtractorTest(TestCase):

    def setUp(self):
        self.sizeRelaxationRatio = 1.10
        self.angleRelaxationInRadians = 0.2
        self.frameExtractor = AnswerSheetFrameExtractor(self.sizeRelaxationRatio, self.angleRelaxationInRadians)
